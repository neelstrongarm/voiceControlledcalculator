...
A Web based Voice Controlled Calculator using Google text-to-speech. Beside basic arithmetic operations, it can also perform operations like percentage and remainder. 
